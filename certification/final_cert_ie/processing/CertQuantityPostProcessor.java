...
public class CertQuantityPostProcessor implements Processor<IeDocument> {
    ...
    public void process(IeDocument document) {
    	...
    	List<Field> allPriceFields = new ArrayList<>(document.findFields(Fields.FIELD_NAME_QUANTITY));
