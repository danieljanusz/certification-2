 ...
 * @param <T>
 */
public class CertInvoiceNumberFE<T extends Element> implements FeatureExtractor<T> {

   // private final String nerType;
    private List<NamedEntity> filteredNamedEntities;
    
    private final static String INVOICE_NO_REGEX = "invoice#([A-Za-z]+)?[0-9]+";
    private final static String FEATURE_NAME = "INVOICE_NO_FEATURE";
